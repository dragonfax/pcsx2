...
#ifdef _DEBUG
static char * libraryName     = "P.E.Op.S. SPU2 SDL (Debug) ";
#else
static char * libraryName     = "P.E.Op.S. SPU2 SDL ";
#endif
static char * libraryInfo     = "P.E.Op.S. SPU2 Driver V1.6 SDL\nCoded by Pete Bernert, Saqib and the P.E.Op.S. team\nSDL version by Ryan Goulden\n";
