...
if(GLSL_API)
	set(msg_dep_zzogl       "check these libraries -> glew, jpeg (>=6.2), opengl, pcsx2 common libs")
else(GLSL_API)
...
#           -zlib
#---------------------------------------
if(OPENGL_FOUND AND ZLIB_FOUND AND PNG_FOUND AND FREETYPE_FOUND AND LIBLZMA_FOUND )
    set(GSdx TRUE)
...
#---------------------------------------
if(EXTRA_PLUGINS)
    if((GLFW_FOUND AND GLEW_FOUND AND OPENGL_FOUND AND JPEG_FOUND AND common_libs))
        set(zzogl TRUE)
