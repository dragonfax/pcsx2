...
extern __inline void write8( u8 val );
extern __inline void write16( u16 val );
extern __inline void write32( u32 val );
extern __inline void write24( u32 val );
...
//#ifdef write8_included
__inline void write8(u8 val )  {  
	*x86Ptr = (u8)val; 
	x86Ptr++; 
} 

__inline void write16(u16 val ) 
{ 
	*(u16*)x86Ptr = (u16)val; 
	x86Ptr += 2;  
} 

__inline void write24(u32 val ) 
{ 
