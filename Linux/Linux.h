...
#else
extern GtkWidget *check_eerec, *check_vu0rec, *check_vu1rec;
extern GtkWidget *check_mtgs , *check_cpu_dc;
extern GtkWidget *check_console , *check_patches;
extern GtkWidget *radio_normal_limit, *radio_limit_limit, *radio_fs_limit, *radio_vuskip_limit;
...
extern int Config_hacks_backup;
